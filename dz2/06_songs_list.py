...
# TODO здесь ваш код
sum = round(violator_songs_list[3][1] + violator_songs_list[5][1] + violator_songs_list[8][1], 2)
print ('Три песни звучат %s минут' % sum)
...
print ('А другие три песни звучат %s минут' % sum_2)
